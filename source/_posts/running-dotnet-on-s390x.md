...
docker run --platform linux/s390x --rm -it \
    registry.access.redhat.com/ubi8/dotnet-90 bash
```
...
```sh
bash-4.4$ uname -a
Linux 1c1a6e356d4d 5.15.153.1-microsoft-standard-WSL2 
#1 SMP Fri Mar 29 23:14:13 UTC 2024 s390x s390x s390x GNU/Linux
```
...
```sh
docker run --platform linux/s390x -v C:\source\myproject:/mnt/myproject -it \
    registry.access.redhat.com/ubi8/dotnet-90 bash
```
